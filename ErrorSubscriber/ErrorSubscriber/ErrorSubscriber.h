...
#include "/home/altair/PhD/Codes/catkin_noetic/devel/include/perception/ErrorOG.h"

// SYSTEM INCLUDES

class ErrorSubscriber : public cedar::proc::Step
{
  Q_OBJECT
  //--------------------------------------------------------------------------------------------------------------------
...
private:
  ...
  void Callback(const perception::ErrorOG::ConstPtr& msg);

...
#include "/home/altair/PhD/Codes/catkin_noetic/devel/include/perception/ObjectGoal.h"
#include "/home/altair/PhD/Codes/catkin_noetic/devel/include/perception/ListGoals.h"

// SYSTEM INCLUDES

class RosGoalSubscriber : public cedar::proc::Step
{
  Q_OBJECT
  //--------------------------------------------------------------------------------------------------------------------
...
private:
  ...
  void Callback(const perception::ListGoals::ConstPtr& msg);
...
private:
  ...
  ros::NodeHandle n;
  ros::Subscriber sub;
  perception::ListGoals list_goals;
  perception::ObjectGoal og;
